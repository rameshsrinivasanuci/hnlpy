...
modelfile = '/home/jenny/pyhddmjagsMN/jagscode/blocked_exp_conds.jags'
f = open(modelfile, 'w')
f.write(tojags)
f.close()
...
savestring = ('/home/jenny/ostwald-data/genparam_test1_model2.mat')
...
ax1 = plt.subplot(141)
jellyfish(samples['delta'][:,0,:,:])
ax1.set_xlim([0, 5])
plt.title('high_coherence_prioritized')

ax2 = plt.subplot(142)
jellyfish(samples['delta'][:,1,:,:])
ax2.set_xlim([0, 5])
plt.title('high_coherence_not_prioritized')

ax3 = plt.subplot(143)
jellyfish(samples['delta'][:,2,:,:])
ax3.set_xlim([0, 5])
plt.title('low_coherence_prioritized')

ax4 = plt.subplot(144)
jellyfish(samples['delta'][:,3,:,:])
ax4.set_xlim([0, 5])
plt.title('low_coherence_not_prioritized')

plt.savefig(('/home/jenny/ostwald-data/prelim_analysis/figures/delta_posteriors_model2_bycond.png'), format='png',bbox_inches="tight")


plt.savefig(('/home/jenny/ostwald-data/prelim_analysis/figures/delta_posteriors_model2.png'), format='png',bbox_inches="tight")



plt.figure(figsize=(40,8))
plt.suptitle('Posterior distributions of the non-decision time parameter by condition' )

ax5 = plt.subplot(141)
jellyfish(samples['ter'][:,0,:,:])
ax5.set_xlim([0.25, 0.7])
plt.title('high_coherence_prioritized')

ax6 = plt.subplot(142)
jellyfish(samples['ter'][:,1,:,:])
ax6.set_xlim([0.25, 0.7])
plt.title('high_coherence_not_prioritized')

ax7 = plt.subplot(143)
jellyfish(samples['ter'][:,2,:,:])
ax7.set_xlim([0.25, 0.7])
plt.title('low_coherence_prioritized')

ax8 = plt.subplot(144)
jellyfish(samples['ter'][:,3,:,:])
ax8.set_xlim([0.25, 0.7])
plt.title('low_coherence_not_prioritized')


plt.figure(figsize=(40,8))
plt.suptitle('Posterior distributions of boundary parameter' )

ax9 = plt.subplot(141)
jellyfish(samples['alpha'][:,0,:,:])
ax9.set_xlim([0.9, 2.7])
plt.title('high_coherence_prioritized')

ax10 = plt.subplot(142)
jellyfish(samples['alpha'][:,1,:,:])
ax10.set_xlim([0.9, 2.7])
plt.title('high_coherence_not_prioritized')

ax11 = plt.subplot(143)
jellyfish(samples['alpha'][:,2,:,:])
ax11.set_xlim([0.9, 2.7])
plt.title('low_coherence_prioritized')

ax12 = plt.subplot(144)
jellyfish(samples['alpha'][:,3,:,:])
ax12.set_xlim([0.9, 2.7])
plt.title('low_coherence_not_prioritized')
...
plt.savefig(('/home/jenny/ostwald-data/prelim_analysis/figures/ter_posteriors_model2.png'), format='png',bbox_inches="tight")

plt.figure(figsize= (8,12))
jellyfish(samples['alpha'])
plt.title('Posterior distributions of boundary parameter')
plt.savefig(('/home/jenny/ostwald-data/prelim_analysis/figures/alpha_posteriors_model2.png'), format='png',bbox_inches="tight")
