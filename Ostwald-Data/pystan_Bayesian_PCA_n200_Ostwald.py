...
condition = np.take(expdict['condition'], finalgoodtrials)
finalgoodtrials1 = []
finalgoodtrials2 = []
finalgoodtrials3 = []
...
for value in condition:
    if value == 1 or value == 4:
        finalgoodtrials1.append(finalgoodtrials[count])
    elif value == 2 or value == 5:
        finalgoodtrials2.append(finalgoodtrials[count])
    elif value == 3 or value == 6:
        finalgoodtrials3.append(finalgoodtrials[count])
    count = count + 1
            
finalgoodtrialList = [finalgoodtrials1, finalgoodtrials2, finalgoodtrials3]        
...
latent_factor_data = {'P': P, 'N': N, 'Y1': Y1, 'Y2': Y2, 'Y3': Y3, 'D': D}
...
window = np.arange(-1250,4000-1250) # Time point 0 is the onset of the visual stimulus

fig, axs = plt.subplots(3, 1,figsize=mm2inch(244,110), sharex='col')
axs[0].plot(window,fullwindowERPs[0])
axs[0].get_yaxis().set_visible(False)
axs[1].plot(window,-fullwindowComp1)
axs[1].get_yaxis().set_visible(False)
axs[2].plot(window,fullwindowComp2)
